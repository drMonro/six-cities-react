...
function Offer({offers}: Pick<AppProps, 'offers'>): JSX.Element {
  const {id}: offerId = useParams();
  const currenOffer = useMemo(() => offers.find((offer) => offer.id.toString() === id), [offers, id]);
  return (
          ...
          <div className="property__wrapper">
            ...
            <div className="property__rating rating">
              <div className="property__stars rating__stars">
                <span className="visually-hidden" style={{width: '80%'}}>span</span>
